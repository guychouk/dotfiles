...
syntax    region typescriptRegexpString start=+/[^/*]+me=e-1                   skip=+\\\\\|\\/+ end=+/[gimsuy]\{0,2\}\s*$+ end=+/[gimsuy]\{0,2\}\s*[;.,)\]}]+me=e-1 contains=@htmlPreproc oneline
...
" typescript/DOM/HTML/CSS specifics
...
" Following stuff should be highlighted within a special context
...
syntax region foldBraces start=/{/ skip=/\(\/\/.*\)\|\(\/.*\/\)/ end=/}/ transparent fold keepend extend
